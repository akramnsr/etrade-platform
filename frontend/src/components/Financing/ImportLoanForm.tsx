...
interface ImportLoanFormProps {
  onSubmit: (dto: CreateFinancingDto) => Promise<void>;
  onCancel?: () => void;
}

const ImportLoanForm: React.FC<ImportLoanFormProps> = ({ onSubmit, onCancel }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <h3 className="text-lg font-semibold text-gray-900">Import Loan Financing</h3>
      <div>
